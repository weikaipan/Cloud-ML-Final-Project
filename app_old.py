...
def startTraining():
    ...
    fwrite = open("training.log", "w")
    # pid = subprocess.Popen(["python", "train/train.py", "-topology","BASELINE"], stdout=fwrite, stderr=fwrite, stdin=subprocess.PIPE)
    pid = subprocess.Popen(["python", "train/train.py", "-topology","BASELINE"],stdout=fwrite, stderr=subprocess.STDOUT)
